...
python scripts/run_experiment.py --method entropy_mcts --num_epochs 2 --run_name 2_epoch_retest --max_tree_nodes 16 --branch_width 3 --steps_per_expansion 8 --num_baseline_samples 8 
