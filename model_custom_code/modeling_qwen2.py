# Local copy of the HuggingFace model's custom code, with the
# `if __name__ == "__main__":` block removed so that the transformers
# dynamic loader does not resolve `import dllm` (avoids circular import).
# Source: dllm-collection/Qwen2.5-Coder-0.5B-Instruct-diffusion-mdlm-v0.1
